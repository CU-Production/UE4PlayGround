...
void AUE4PlayGroundCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AUE4PlayGroundCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AUE4PlayGroundCharacter::TouchStopped);
...
{
	// If UE4PlayGround is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in UE4PlayGround.Build.cs is not automatically propagated
...
void AUE4PlayGroundCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AUE4PlayGroundCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
